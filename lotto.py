...
class Loto:
    ...
    def get_card(self, card_player):
        ...
        print('{0[0]:>2} {0[1]:<2} {0[2]:<2} {0[3]} {0[4]} '.format(card_player[0]))
        print('{0[0]:>2} {0[1]:<2} {0[2]:<2} {0[3]:<1} {0[4]} '.format(card_player[1]))
        print('{0[0]:>2} {0[1]:<2} {0[2]:<2} {0[3]:<1} {0[4]} '.format(card_player[2]))
        print('{:-^40}'.format('-'))
